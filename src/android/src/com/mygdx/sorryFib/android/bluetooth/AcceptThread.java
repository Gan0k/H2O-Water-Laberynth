package com.mygdx.sorryFib.android.bluetooth;
...
class AcceptThread extends Thread {
    ...
    private static final String NAME = "WaterLaberynth";
    private static final UUID MY_UUID = UUID.fromString("fa87f0d0-afac-11de-8a39-0800200c9a66");
